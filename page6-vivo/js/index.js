...
$(window).scroll(function() {
    ...
    if(num <100){
        // $('.main-carousel').css({filter:"blur("+10/7+")"})
        $('.main-carousel').css("filter","blur("+10/7+")")
    }else if(num<200){
        $('.main-carousel').css({filter:"blur("+10/7*2+")"})
    }else if(num<300){
        $('.main-carousel').css({filter:"blur("+10/7*3+")"})
    }else if(num<400){
        $('.main-carousel').css({filter:"blur("+10/7*4+")"})
    }else if(num<500){
        $('.main-carousel').css({filter:"blur("+10/7*5+")"})
    }else if(num<600){
        $('.main-carousel').css({filter:"blur("+10/7*6+")"})
    }else if(num<700){
        $('.main-carousel').css({filter:"blur("+10/7*7+")"})
    }else {
        $('.main-carousel').css({filter:"blur("+10/7*7+")"})
    }
